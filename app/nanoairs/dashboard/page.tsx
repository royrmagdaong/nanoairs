        ...
        <div className="grid grid-cols-1 gap-3">
          <div className="hover:bg-cyan-100 cursor-pointer" onClick={()=>{router.push('/nanoairs/dashboard/raceways-1')}}>
            ...
            <div className="grid grid-cols-6 gap-2">
              <SensorCardGauge title={'Temperature'} value={0} average={0} units={'ºC'}/>
              <SensorCardGauge title={'pH'} value={0} average={0} units={''}/>
              <SensorCardGauge title={'Salinity'} value={0} average={0} units={'ppt'}/>
              <SensorCardGauge title={'Dissolved Oxygen'} value={0} average={0} units={'ºC'}/>
              <SensorCardGauge title={'Alkalinity'} value={0} average={0} units={''}/>
              <SensorCardGauge title={'Dissolved CO2'} value={0} average={0} units={'ppt'}/>
            </div>
          </div>
