      ...
      <main className="flex h-screen items-center justify-center bg-blue-100">
         <div className='relative'>
            ...
            {/* container 4 */}
              ...
              <div className={`${displayContainer4?'inline':'hidden'} text-white hidden  absolute top-[48%] left-[39.9%]`}>
            ...
            {/* container 5 */}
              ...
              <div className={`${displayContainer5?'inline':'hidden'} text-white hidden  absolute top-[45%] left-[44.9%]`}>
            ...
            {/* container 6 */}
              ...
              <div className={`${displayContainer6?'inline':'hidden'} text-white hidden  absolute top-[42%] left-[48.9%]`}>
            ...
            {/* container 7 */}
              ...
              <div className={`${displayContainer7?'inline':'hidden'} text-white hidden  absolute top-[39%] left-[53.9%]`}>
            ...
            {/* container 8 */}
              ...
              <div className={`${displayContainer8?'inline':'hidden'} text-white hidden  absolute top-[38%] left-[57.9%]`}>
            ...
            {/* container 9 */}
              ...
              <div className={`${displayContainer9?'inline':'hidden'} text-white hidden  absolute top-[35%] left-[62.9%]`}>
            ...
            {/* container 10 */}
              ...
              <div className={`${displayContainer10?'inline':'hidden'} text-white hidden  absolute top-[32%] left-[67.9%]`}>
            ...
            {/* container 11 */}
              ...
              <div className={`${displayContainer11?'inline':'hidden'} text-white hidden  absolute top-[30%] left-[71.8%]`}>
              ...
              <div className={`${displayTank1?'inline':'hidden'} text-white hidden  absolute top-[1%] left-[45.8%]`}>
              ...
              <div className={`${displayT1?'inline':'hidden'} text-white hidden  absolute top-[32%] left-[45.8%]`}>
              ...
              <div className={`${displaySensorNode?'inline':'hidden'} text-white hidden  absolute top-[2%] left-[47.8%]`}>
              ...
              <div className={`${displaySensors?'inline':'hidden'} text-white hidden  absolute top-[16%] left-[43.8%]`}>
              ...
              <div className={`${displayHeater?'inline':'hidden'} text-white hidden  absolute top-[29%] left-[65.8%]`}>
              ...
              <div className={`${displayControlPanel?'inline':'hidden'} text-white hidden  absolute top-[29%] left-[69.8%]`}>
